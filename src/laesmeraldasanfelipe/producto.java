...
public class producto extends javax.swing.JInternalFrame {
    ...
    public producto() {
        ...
        Conexion.mostrarEntrada(jTable1);
    ...
    public variablesEntrada dar_valores() {
    
    
        variablesEntrada r = null;
        String entrada_Producto_ID = jTextField1.getText();
        ...
        r = new variablesEntrada(entrada_Producto_ID, Fecha, Cantidad);
        return r;
    }
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        BuscarProducto obj=new BuscarProducto();
        obj.setVisible(true);
    }//GEN-LAST:event_jButtonBuscarActionPerformed

    private void jButtonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertarActionPerformed
        variablesEntrada x = null;
        x = dar_valores();
       
            Conexion.guardarEntrada(x);
